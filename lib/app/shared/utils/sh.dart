...
class BubbleShape extends Shape {
  ...
  BubbleShape({this.position = BubblePosition.Bottom, this.borderRadius = 12, this.arrowHeight = 10, this.arrowWidth = 10, this.arrowPositionPercent = 0.5});
...
class MyShapeBorder extends ShapeBorder {
  ...
  const MyShapeBorder({required this.shape});
  @override
